...
(function ( $ ) {                  // Compliant with jquery.noConflict()
  $.fn.jMyCarousel = function(o) {   
    o = $.extend({
      ...
      evtStart : 'mouseover touchstart',   // start event that we want for the animation (click, mouseover, mousedown, etc..)
      evtStop : 'mouseout touchend',     // stop event that we want for the animation (blur, mouseout, mouseup, etc..)
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.   
      ...
      if(o.btnPrev){            
        $(o.btnPrev).on(o.evtStart, function(event) {
	  event.preventDefault();
        ...
        $(o.btnPrev).on(o.evtStop, function(event) {
	  event.preventDefault();
      ...
      if(o.btnNext){
        $(o.btnNext).on(o.evtStart, function(event) {
	  event.preventDefault();
        ...
        $(o.btnNext).on(o.evtStop,function(event) {
	  event.preventDefault();
